...
public class AES implements interfaces.TwoArguments {
	...
	/**
	 * 
	 * This class gets an input String and an password.
	 * Firest the input is encrypted and afterwards decrypted again.
	 * 
	...
	/**
	 * This method converts the password from String to SecretKeySpec.
	 * It was moved here vor readability of the code.
	 * 
	 * @param password
	 *        The password as String.
	 * @return The password as SecretKeySpec.
	 */
